...
import com.shop.ordering.domain.model.exception.PedidoDataEntregaInvalidaException;
import com.shop.ordering.domain.model.exception.PedidoNaoComtenItemException;
import com.shop.ordering.domain.model.exception.PedidoNaoPodeSerAlteradoException;
import com.shop.ordering.domain.model.exception.PedidoNaoPodeSerRealizadoException;
...
public class Pedido implements RaizDeAgregado<PedidoId> {
